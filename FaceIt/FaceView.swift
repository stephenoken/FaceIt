...
class FaceView: UIView {
    ...
    @IBInspectable
    var eyeBrowTilt = -0.5 { didSet {setNeedsDisplay() } } //1 Full furrow, -1 full furrow
    @IBInspectable
    ...
    private func pathForCircleCenteredAtPoint(midPoint:CGPoint,widthRadius:CGFloat) -> UIBezierPath {
        let path =  UIBezierPath(arcCenter: midPoint, radius: widthRadius, startAngle: 0.0, endAngle: CGFloat(2*M_PI), clockwise: false)
        path.lineWidth = 5.0
